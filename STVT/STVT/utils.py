...
def save_model(model, args, best_fscore_k, epoch):
    if os.path.exists("/content/newvideosummcolab/STVT/STVT/model/"+args.dataset+"/model_" + str(args.roundtimes) + "_roundtimes"):
        shutil.rmtree("/content/newvideosummcolab/STVT/STVT/model/"+args.dataset+"/model_" + str(args.roundtimes) + "_roundtimes")
    if not os.path.exists("/content/newvideosummcolab/STVT/STVT/model/"+args.dataset+"/model_" + str(args.roundtimes)+"_roundtimes"):
        os.mkdir("/content/newvideosummcolab/STVT/STVT/model/"+args.dataset+"/model_" + str(args.roundtimes)+"_roundtimes")
    path = "/content/newvideosummcolab/STVT/STVT/model/"+args.dataset+"/model_"+str(args.roundtimes)+"_roundtimes/"+str(args.dataset)+"_"+str(epoch)+"_"+str(best_fscore_k)+".pth"
